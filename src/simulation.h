...
// void run_initialize_initial_state(int trajectories_count, unit_state_t* states, float* times, curandState* rands,
...
// 				  int trajectory_limit, unit_state_t* last_states, float* last_times, curandState* rands,
